        ...
        <div class="aside-content">
            <div class="content">
                <div class="aside-header">
                    ...
                    <p class="description text-muted small">Prospecção de negócios</p>
                </div>
            </div>
            <div class="aside-nav collapse">
                ...
                <div class="tab-content">
                    <div class="tab-pane {{ !in_url('reports') ? 'active' : '' }}" id="links" role="tabpanel">
                        ...
                        <ul class="navigation">
                            <li class="{{ active_url('leads') }}"><a href="{{ route('dashboard.leads') }}"><i class="icon-home"></i> Painel</a></li>
                            <li class="navigation-header">Geral</li>
                            <li ><a href="#"><i class="icon-speech"></i> Leads</a></li>
                        </ul>
