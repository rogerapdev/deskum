			...
			<div class="card">
			    ...
			    <div class="card-body">
			    	<fieldset class="filters pb-5" style="display: none;">
			    		...
			    		<form class="form-horizontal" action="{{ route('projects.index') }}" >
			    		...
			    		<div class="row">
			    			<div class="col-md-12 text-right">
								<a href="{{ route('projects.index') }}" class="btn btn-default" role="button">Limpar</a>
			                ...
			                <tr>
								...
								<td class="text-right">
									...
									<div class="dropdown-menu dropdown-menu-right" style="text-transform: none;">
										<a class="dropdown-item" href="{{ route('projects.edit', [Hasher::encode($project->id)]) }}"><i class="far fa-edit fa-1x"></i> Alterar</a>
										<a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal-delete" data-token="{{ csrf_token() }}" data-method="delete" data-href="{{ route('projects.delete', Hasher::encode($project->id) ) }}"><i class="text-danger far fa-times-circle fa-1x"></i> Remover</a>
									</div>
