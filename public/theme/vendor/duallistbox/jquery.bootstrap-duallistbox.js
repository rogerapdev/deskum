  ...
  BootstrapDualListbox.prototype = {
    ...
    setBootstrap2Compatible: function(value, refresh) {
      ...
      if (value) {
        ...
        this.container.find('.moveall > i, .move > i').removeClass('im-arrow-right22').addClass('icon-arrow-right');
        this.container.find('.removeall > i, .remove > i').removeClass('im-arrow-left22').addClass('icon-arrow-left');
      } else {
        ...
        this.container.find('.moveall > i, .move > i').removeClass('icon-arrow-right').addClass('im-arrow-right22');
        this.container.find('.removeall > i, .remove > i').removeClass('icon-arrow-left').addClass('im-arrow-left22');
      }
      if (refresh) {
        refreshSelects(this);
      }
